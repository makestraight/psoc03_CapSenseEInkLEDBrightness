...
*              CapSense buttons. Button 0 selects the option, Button 1 goes
*              back to the menu page, and the slider allows users to switch
*              different options in menu page and controls the brightness of
*              the LED in brightness page. The code example also features
...
* Example Code Name: CAPSENSE™ Buttons and Slider FreeRTOS
...
int main(void)
{
    ...
    eink_command_q = xQueueCreate(SINGLE_ELEMENT_QUEUE,
                                      sizeof(eink_command_t));
